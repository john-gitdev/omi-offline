...
Uint8List _createOggOpusIdHeader() {
  ...
  header.setUint8(8, 1);
  header.setUint8(9, 1); // mono
  header.setUint16(10, 0, Endian.little); // Pre-skip
  header.setUint32(12, 48000, Endian.little); // Original sample rate always 48k for opus
...
void main() async {
  ...
  // Add 16kHz silence frames
  final opusSilenceFrame = Uint8List.fromList([0x48, 0x0b, 0xe4, 0xc1, 0x36, 0xec, 0xc5, 0x80, 0x48, 0x07, 0xc9, 0x72, 0x27, 0xe1, 0x44, 0xea, 0x50]);
  
  sink.add(_createOggPage(960, 2, serial, [opusSilenceFrame]));
  sink.add(_createOggPage(1920, 3, serial, [opusSilenceFrame], isLastPage: true));
