...
- **App**: `_releasePairingOnSuccess` calls `unmanageDevice` **then** `removeBond` from the DFU success callbacks (Android only — iOS has no programmatic bond removal).
