...
| [`c4106b09d`](https://github.com/BasedHardware/omi/commit/c4106b09d) | `OmiCompanionManager.kt` | `CompanionDeviceManager` API compat for Android < 13: fallback to legacy `associate()`, `associations`, and skip observing | Integrated |
