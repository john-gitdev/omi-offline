...
class OmiDeviceConnection extends DeviceConnection {
      ...
      _listFilesSub = stream.listen((blePacket) {
        ...
        if (expectedTotalBytes != null &&
          ...
          final bd = ByteData.sublistView(
            Uint8List.fromList(buffer.sublist(0, expectedTotalBytes!)),
          );
          ...
          Logger.debug(
            'OmiDeviceConnection: Successfully parsed all $count files',
          );
          success(files);
        }
      });
  ...
  @override
  Future<Stream<List<int>>> performReadFile(
    StorageFile file, {
    int offset = 0,
  }) async {
