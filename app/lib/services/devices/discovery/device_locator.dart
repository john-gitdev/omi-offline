enum DeviceLocatorKind { bluetooth, watch }

class DeviceLocator {
  final DeviceLocatorKind kind;
  final String? deviceId;

  const DeviceLocator({required this.kind, this.deviceId});
  ...
  factory DeviceLocator.fromJson(Map<String, dynamic> json) {
    return DeviceLocator(kind: DeviceLocatorKind.values[json['kind']], deviceId: json['deviceId']);
  }

  Map<String, dynamic> toJson() {
    return {'kind': kind.index, 'deviceId': deviceId};
  }
}
