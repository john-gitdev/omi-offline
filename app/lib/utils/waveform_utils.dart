...
class WaveformUtils {
  ...
  static WavInfo? _parseWavHeader(Uint8List wavData) {
    ...
    // ⚡ Bolt: Use String.fromCharCodes with start/end arguments instead of .sublist() to avoid copying
    ...
    // ⚡ Bolt: Hoist ByteData.sublistView to prevent creating a new view per loop iteration
