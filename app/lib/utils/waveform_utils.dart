...
class WaveformUtils {
  ...
  static WavInfo? _parseWavHeader(Uint8List wavData) {
    ...
    // ⚡ Bolt: Use positional arguments in String.fromCharCodes to avoid expensive deep copy from .sublist()
    ...
    while (offset < wavData.length - 8) {
      // ⚡ Bolt: Use positional arguments in String.fromCharCodes to avoid expensive deep copy from .sublist() inside loop
      ...
      if (chunkId == 'fmt ') {
        ...
        final audioFormat = ByteData.sublistView(
          wavData,
          offset + 8,
          offset + 10,
