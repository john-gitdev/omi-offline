...
Targeting _$TargetingFromJson(Map<String, dynamic> json) => Targeting(
      ...
      deviceModels: (json['device_models'] as List<dynamic>?)?.map((e) => e as String).toList(),
      platforms: (json['platforms'] as List<dynamic>?)?.map((e) => e as String).toList(),
      trigger: $enumDecodeNullable(_$TriggerTypeEnumMap, json['trigger']) ?? TriggerType.versionUpgrade,
      testUids: (json['test_uids'] as List<dynamic>?)?.map((e) => e as String).toList(),
    );
...
Display _$DisplayFromJson(Map<String, dynamic> json) => Display(
      ...
      startAt: json['start_at'] == null ? null : DateTime.parse(json['start_at'] as String),
...
ChangelogItem _$ChangelogItemFromJson(Map<String, dynamic> json) => ChangelogItem(
      title: json['title'] as String,
      description: json['description'] as String,
      icon: json['icon'] as String?,
    );

Map<String, dynamic> _$ChangelogItemToJson(ChangelogItem instance) => <String, dynamic>{
      'title': instance.title,
      'description': instance.description,
      'icon': instance.icon,
    };

ChangelogContent _$ChangelogContentFromJson(Map<String, dynamic> json) => ChangelogContent(
      title: json['title'] as String,
      changes:
          (json['changes'] as List<dynamic>).map((e) => ChangelogItem.fromJson(e as Map<String, dynamic>)).toList(),
    );

Map<String, dynamic> _$ChangelogContentToJson(ChangelogContent instance) => <String, dynamic>{
      'title': instance.title,
...
Map<String, dynamic> _$FeatureStepToJson(FeatureStep instance) => <String, dynamic>{
      'title': instance.title,
      'description': instance.description,
...
FeatureContent _$FeatureContentFromJson(Map<String, dynamic> json) => FeatureContent(
      title: json['title'] as String,
      steps: (json['steps'] as List<dynamic>).map((e) => FeatureStep.fromJson(e as Map<String, dynamic>)).toList(),
    );

Map<String, dynamic> _$FeatureContentToJson(FeatureContent instance) => <String, dynamic>{
      'title': instance.title,
      'steps': instance.steps.map((e) => e.toJson()).toList(),
    };

AnnouncementCTA _$AnnouncementCTAFromJson(Map<String, dynamic> json) => AnnouncementCTA(
      text: json['text'] as String,
      action: json['action'] as String,
    );

Map<String, dynamic> _$AnnouncementCTAToJson(AnnouncementCTA instance) => <String, dynamic>{
      'text': instance.text,
      'action': instance.action,
    };

AnnouncementContent _$AnnouncementContentFromJson(Map<String, dynamic> json) => AnnouncementContent(
      title: json['title'] as String,
...
Map<String, dynamic> _$AnnouncementContentToJson(AnnouncementContent instance) => <String, dynamic>{
      'title': instance.title,
      'body': instance.body,
      'image_url': instance.imageUrl,
...
Announcement _$AnnouncementFromJson(Map<String, dynamic> json) => Announcement(
      ...
      deviceModels: (json['device_models'] as List<dynamic>?)?.map((e) => e as String).toList() ?? [],
      expiresAt: json['expires_at'] == null ? null : DateTime.parse(json['expires_at'] as String),
      targeting: json['targeting'] == null ? null : Targeting.fromJson(json['targeting'] as Map<String, dynamic>),
      display: json['display'] == null ? null : Display.fromJson(json['display'] as Map<String, dynamic>),
