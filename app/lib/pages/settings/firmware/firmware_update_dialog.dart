  ...
  Map<String, FirmwareUpdateStep> _getStepMap(BuildContext context) {
    return {
      'no_usb': FirmwareUpdateStep(
        ...
        description: 'Please unplug your device before updating',
        icon: FontAwesomeIcons.plug,
      ),
      'battery': FirmwareUpdateStep(
        title: 'Battery level above 15%',
        description: 'Ensure battery doesn\'t die during update',
        icon: FontAwesomeIcons.batteryHalf,
      ),
      'internet': FirmwareUpdateStep(
        title: 'Stable internet connection',
        description: 'Connect to Wi-Fi for faster download',
  ...
  void _onConfirmed() {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Failed to start update: ${e.toString()}'), backgroundColor: Colors.red),
      );
    }
  }
