...
class _SeekBtn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Semantics(
      button: true,
      label: isForward ? 'Seek forward $seconds seconds' : 'Seek backward $seconds seconds',
      child: Tooltip(
        message: isForward ? 'Seek forward $seconds seconds' : 'Seek backward $seconds seconds',
        child: Material(
