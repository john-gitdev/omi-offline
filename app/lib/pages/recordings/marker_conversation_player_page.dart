                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        _SeekBtn(isForward: false, icon: FontAwesomeIcons.rotateLeft, seconds: 30, onTap: () => _seekRelative(-30)),
                        ...
                        const SizedBox(width: 40),
                        _SeekBtn(isForward: true, icon: FontAwesomeIcons.rotateRight, seconds: 30, onTap: () => _seekRelative(30)),
                      ],
                    ),
                    const SizedBox(height: 24),
...
class _SeekBtn extends StatelessWidget {
  ...
  const _SeekBtn({required this.isForward, required this.icon, required this.seconds, required this.onTap});
